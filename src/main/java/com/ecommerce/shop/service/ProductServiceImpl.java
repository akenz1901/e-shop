...
public class  ProductServiceImpl implements ProductService{
    ...
    @Override
    public Product update(Long id, ProductDto productDto) throws ProductNotFoundExistException {
        if(productDto==null){
        ...
        if(result.isPresent()){
            ...
            throw new ProductNotFoundExistException("Product with id " + id + "does not exist");
        }
    }
